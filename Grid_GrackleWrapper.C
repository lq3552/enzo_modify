...
int grid::GrackleWrapper()
{
  ...
  int DeNum, HINum, HIINum, HeINum, HeIINum, HeIIINum, HMNum, H2INum, H2IINum,
      DINum, DIINum, HDINum, DensNum, GENum, Vel1Num, Vel2Num, Vel3Num, TENum,G0Num,ZetaNum;
  ...
  if (this->IdentifyPhysicalQuantities(DensNum, GENum, Vel1Num, Vel2Num,
				       Vel3Num, TENum, G0Num, ZetaNum) == FAIL) { //Here G0 and Zeta must be initialized, but can change for universal usage... add a grackle rank as parameter
  ...
  float *fuv_G0		 = BaryonField[G0Num];
  float *cr_Zeta		 = BaryonField[ZetaNum];
  ...
  /* Call the chemistry solver. */
    if (solve_chemistry(&grackle_units,
                      ...
                      velocity1, velocity2, velocity3,fuv_G0,cr_Zeta, //!! Here updated, hohoho
